...
// node_modules/seqparse/dist/index.js
var require_dist = __commonJS({
  "node_modules/seqparse/dist/index.js"(exports, module) {
        ...
        (() => {
          ...
          var __webpack_modules__ = [
            ...
            function(__unused_webpack_module, exports2, __webpack_require__2) {
              ...
              exports2.parseFile = void 0;
              var fetchFile_1 = __webpack_require__2(1);
              var parseFile_1 = __webpack_require__2(3);
              exports2.parseFile = parseFile_1.default;
              exports2["default"] = function(input, options) {
                  ...
                  return __generator(this, function(_a) {
                    switch (_a.label) {
                      ...
                      case 1:
                        return [2, _a.sent()];
                      case 2:
                        return [2, (0, parseFile_1.default)(input, options)[0]];
                    }
                  });
                });
              };
            ...
            function(__unused_webpack_module, exports2, __webpack_require__2) {
              ...
              Object.defineProperty(exports2, "__esModule", { value: true });
              exports2.isAccession = void 0;
              var node_fetch_1 = __webpack_require__2(2);
              var parseFile_1 = __webpack_require__2(3);
              exports2["default"] = function(accession, options) {
                return __awaiter(void 0, void 0, void 0, function() {
              ...
              exports2.isAccession = isAccession;
            },
            /* 2 */
            /***/
            (module2) => {
              module2.exports = (init_lib(), __toCommonJS(lib_exports));
            },
            /* 3 */
            /***/
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              Object.defineProperty(exports2, "__esModule", { value: true });
              var path_1 = __webpack_require__2(4);
              var benchling_1 = __webpack_require__2(5);
              var biobrick_1 = __webpack_require__2(7);
              var fasta_1 = __webpack_require__2(9);
              var genbank_1 = __webpack_require__2(10);
              var jbei_1 = __webpack_require__2(11);
              var sbol_1 = __webpack_require__2(12);
              var seqbuilder_1 = __webpack_require__2(15);
              var snapgene_1 = __webpack_require__2(16);
              var utils_1 = __webpack_require__2(6);
              exports2["default"] = function(file, opts) {
                ...
                var dnaOnlyFile = dnaCharLength / firstLine.length > 0.8;
                ...
                try {
                  ...
                  if (["bases", "annotations", "primers"].every(function(k) {
                ...
                switch (true) {
                  ...
                  case dnaOnlyFile: {
                    ...
                    seqs = [{ annotations: [], name, seq, type: (0, utils_1.guessType)(seq) }];
                    break;
                  }
                  default:
            ...
            function(__unused_webpack_module, exports2, __webpack_require__2) {
              ...
              Object.defineProperty(exports2, "__esModule", { value: true });
              var utils_1 = __webpack_require__2(6);
              exports2["default"] = function(text) {
            ...
            (__unused_webpack_module, exports2) => {
              Object.defineProperty(exports2, "__esModule", { value: true });
              exports2.guessType = exports2.parseDirection = exports2.firstElement = exports2.reverseComplement = exports2.complement = void 0;
              var comp = {
                A: "T",
                B: "V",
                C: "G",
              ...
              var reverseComplement = function(inputSeq) {
                var compSeq = (0, exports2.complement)(inputSeq).compSeq;
                return compSeq.split("").reverse().join("");
              };
              exports2.reverseComplement = reverseComplement;
              var firstElement = function(arr) {
                if (!Array.isArray(arr))
                  return void 0;
                return arr[0];
              };
              exports2.firstElement = firstElement;
              var fwd = /* @__PURE__ */ new Set(["FWD", "fwd", "FORWARD", "forward", "FOR", "for", "TOP", "top", "1", 1]);
              var rev = /* @__PURE__ */ new Set(["REV", "rev", "REVERSE", "reverse", "BOTTOM", "bottom", "-1", -1]);
              ...
              exports2.guessType = guessType;
            },
            /* 7 */
            /***/
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              Object.defineProperty(exports2, "__esModule", { value: true });
              var fast_xml_parser_1 = __webpack_require__2(8);
              var utils_1 = __webpack_require__2(6);
              exports2["default"] = function(file) {
                var bail = function(err) {
                  throw new Error("Failed on BioBrick: ".concat(err));
                };
                var parsedBiobrick = new fast_xml_parser_1.XMLParser({
                  isArray: function(name2) {
                    return ["features", "part_name", "sequences"].includes(name2);
                  },
                  removeNSPrefix: true
                }).parse(file);
            ...
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              Object.defineProperty(exports2, "__esModule", { value: true });
              var utils_1 = __webpack_require__2(6);
              exports2["default"] = function(text, fileName) {
                if (text.trim().startsWith(">")) {
                  return text.split(">").map(function(t) {
                    var seq2 = t.substr(t.indexOf("\n"), t.length).replace(/\s/g, "");
                    var name2 = t.substring(0, t.search(/\n|\|/)).replace(/\//g, "");
                    return {
                      annotations: [],
                      name: name2,
                      seq: seq2,
                      type: (0, utils_1.guessType)(seq2)
                    };
                  }).filter(function(p) {
                    return p.name && p.seq;
                  });
            ...
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              Object.defineProperty(exports2, "__esModule", { value: true });
              var utils_1 = __webpack_require__2(6);
              var tagNameSet = /* @__PURE__ */ new Set(["gene", "product", "note", "db_xref", "protein_id", "label", "lab_host", "locus_tag"]);
              var tagColorSet = /* @__PURE__ */ new Set(["ApEinfo_fwdcolor", "ApEinfo_revcolor", "loom_color"]);
              exports2["default"] = function(fileInput, fileName) {
                return fileInput.split(/\/\/\s/g).filter(function(f) {
                  return f.length > 5;
                }).map(function(file) {
                  var HEADER_ROW = file.substring(file.indexOf("LOCUS"), file.search(/\\n|\n/));
                  var _a = HEADER_ROW.split(/\s{2,}/g).filter(function(h) {
                    return h;
                  }), name = _a[1];
                  var parsedName = name;
                  if (parsedName === "Exported" && file.includes("SnapGene") || // stupid Snapgene name
                  Number.parseInt(parsedName, 10)) {
                    ...
                    if (!accessionName && fileName) {
                      parsedName = fileName.substring(0, Math.max(fileName.search(/\n|\||\./), fileName.lastIndexOf("."))).replace(/\/\s/g, "");
                  ...
                  if (file.indexOf("FEATURES")) {
                    ...
                    var FEATURES_ROWS = file.substring(FEATURES_NEW_LINE, ORIGIN_LINE).split(/\n/).filter(function(r) {
                      return r;
                    });
                    FEATURES_ROWS.forEach(function(r) {
                      ...
                      if (currLine.length > 1) {
                        ...
                        var _a2 = [0, 0], start = _a2[0], end = _a2[1];
            ...
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              ...
              var fast_xml_parser_1 = __webpack_require__2(8);
              var utils_1 = __webpack_require__2(6);
              exports2["default"] = function(JBEI) {
            ...
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              Object.defineProperty(exports2, "__esModule", { value: true });
              var sbol_v1_1 = __webpack_require__2(13);
              var sbol_v2_1 = __webpack_require__2(14);
              exports2["default"] = function(sbol, fileName) {
            ...
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              ...
              var fast_xml_parser_1 = __webpack_require__2(8);
              var utils_1 = __webpack_require__2(6);
              exports2["default"] = function(sbol) {
                ...
                if (Collection && Collection.length) {
                  ...
                  Collection.forEach(function(_a) {
                    ...
                    if (component && component.length) {
                      component.forEach(function(_a2) {
                        var nestedDnaComponent = _a2.DnaComponent;
                        partList_1.push(
              ...
              var dnaComponentToPart = function(DnaComponent, options) {
                ...
                var annotations = [];
                if (annotation) {
                  annotation.forEach(function(_a2) {
                    var SequenceAnnotation = _a2.SequenceAnnotation;
              ...
              var sequenceToPart = function(Seq, file) {
                ...
                return { annotations: [], circular, compSeq, name, seq, type: (0, utils_1.guessType)(seq) };
              };
            ...
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              ...
              var parseSBOL2 = function(parsedSBOL, fileName) {
                ...
                ComponentDefinition === null || ComponentDefinition === void 0 ? void 0 : ComponentDefinition.forEach(function(c, i) {
                  ...
                  var seq2 = getSeq(sequence["@_resource"]);
                  if (seq2) {
                    seqList.push({
                      annotations,
                      name,
            ...
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              ...
              exports2["default"] = function(fileInput, fileName) {
                return fileInput.split(/\/\/\s/g).map(function(file) {
                  var SEQ_ROWS = file.substring(file.search(/.*?written by seqbuilder .*?[0-9.]+[^actg]+/i) + // @ts-ignore
                  file.match(/.*?written by seqbuilder .*?[0-9.]+[^actg]+/i)[0].length, file.length).match(/[actgyrwskmdvhbxn]+/gim)[0];
                  var seq = SEQ_ROWS;
                  seq = (0, utils_1.complement)(seq).seq;
            ...
            function(__unused_webpack_module, exports2, __webpack_require__2) {
              ...
              var path_1 = __webpack_require__2(4);
              var utils_1 = __webpack_require__2(6);
              exports2["default"] = function(options) {
                var _a;
                ...
                var offset = 0;
                var read = function(size2) {
                  var start = offset;
                  offset += size2;
                  return buffer.subarray(start, offset);
                };
                var readEnc = function(size2, fmt) {
                  return read(size2).toString(fmt);
                };
                read(1);
                ...
                while (offset < buffer.length) {
                  ...
                  if (ord === 0) {
                    ...
                    b.Features.Feature.forEach(function(feature) {
                      ...
                      var _a2 = range.split("-"), start = _a2[0], end = _a2[1];
...
// src/transform.ts
var seqparse = __toESM(require_dist(), 1);
